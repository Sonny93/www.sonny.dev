    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <header className="text-center mb-16">
        <h1 className="text-6xl font-bold text-white mb-4">
          <Trans>Hello, I'm</Trans>{' '}
          <span className="text-purple-400">Sonny</span>✌️
        </h1>
        <p className="text-xl text-gray-300 mb-8">
          <Trans>Fullstack Developer passionate</Trans>
        </p>
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            <Trans>
              ...
              applications using the latest technologies. My expertise covers
              the frontend and the backend to offer complete solutions.
            </Trans>
          </p>
      ...
      <footer className="text-center mt-16">
        <p className="text-gray-400">
          © 2025 {PROJECT_NAME} - <Trans>Fullstack Developer</Trans>
        </p>
      </footer>
    </div>
  </div>
